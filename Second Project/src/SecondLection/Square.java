...
public class Square extends Shape {
    ...
    public double getPerimeter() {
        if (p3.getX() - p1.getX() == p3.getY() - p1.getY()) {
            return (Math.sqrt(Math.pow(p2.getX() - p1.getX(), 2) + Math.pow(p2.getY() - p1.getY(), 2))) * 4;
        }
        return 0;
    }
    ...
    public double getArea() {
        if (p3.getX() - p1.getX() == p3.getY() - p1.getY()) {
            return Math.pow(Math.sqrt(Math.pow(p2.getX() - p1.getX(), 2) + Math.pow(p2.getY() - p1.getY(), 2)), 2);
        }
        return 0;
    }
